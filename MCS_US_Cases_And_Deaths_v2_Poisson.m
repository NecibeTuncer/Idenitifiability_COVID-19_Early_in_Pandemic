...
true_params = [0.0673, 0.0002,0.0042,0.1590,0.9997,0.0091,1429.39,0.1147,106.07,0.0003];
...
%ub = [1e+5 1e+5 0.35 1 1 1 1e+5 1 1e+5 1];
 ...
 Reproduction_Number = S0N0ratio *(true_params(2)/params(3) + (1-params(4))*true_params(9)/params(5) + params(4)*params(1)/(params(10) + params(7)));
...
save('MCS_US_Cases_And_Deathsv2_Poisson')
